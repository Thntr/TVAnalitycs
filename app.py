...
# --- Configuration ---
st.set_page_config(page_title="TVAnalytics | Scientific Dashboard", layout="wide", page_icon="🪐")
...
with st.sidebar:
    ...
    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 30px; padding-left: 10px;">
        ...
        <div>
            <h2 style="margin:0; font-size: 18px; font-weight: 700;">TVAnalytics</h2>
...
# 2. ANALYTICS (Content Intel)
    ...
    st.markdown("<h1>TVAnalytics <span style='font-weight:300;opacity:0.7'>// Content Intel</span></h1>", unsafe_allow_html=True)
